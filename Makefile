...
#
#@MD5TINOIGN@ Creation date: Thu Nov 10 15:10:10 CET 2016
#
# This file is based on following files:
#@MD5TINOIGN@ 1: Makefile.tino
#@MD5TINOIGN@ 2: /home/tino/src/keypressed/tino/Makefile.proto
...
ADD_LDFLAGS=
 ADD_LDLIBS=
  ...
  CLEANDIRS=
  DISTCLEAN=
   TINOCOPY=tino/keypressed.h

 INSTALLPATH=/usr/local

#
#@MD5TINOIGN@ included: /home/tino/src/keypressed/tino/Makefile.proto
#
...
tino_keypressed.h:	Makefile.md5
	$(TOUCH) tino_keypressed.h

# compiler generated dependencies, remove if incorrect

# included: keypressed.d
$(PROG1).o:  keypressed.c keypressed_version.h tino_keypressed.h
